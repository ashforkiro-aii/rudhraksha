...
const WHATSAPP_NUMBER = "919281444571"
...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-[#1C1006] mb-2" style={{ fontFamily: 'Georgia, serif' }}>Contact Us</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
        {[
          ...
          { icon: <Phone size={20} />, label: 'Phone / WhatsApp', value: '+91 92814 44571' },
      ...
      <div className="flex items-center gap-4 mb-8">
        <a href="https://wa.me/919281444571" target="_blank" rel="noopener noreferrer"
