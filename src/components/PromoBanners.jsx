...
const DEFAULT_BANNERS = [
  ...
  { id: 2, badge: "NEW ARRIVALS", title: "Rudraksha Mala", subtitle: "Starting ₹599", desc: "Authentic 108 bead prayer malas", price: "599", originalPrice: "", cta: "Explore", link: "/products?category=Rudraksha+Mala", bg: "from-[#0a001a] to-[#1f003d]", accent: "#C084FC", image: "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=300&q=80" },
  { id: 3, badge: "BESTSELLER", title: "5 Mukhi Rudraksha", subtitle: "Lab Certified", desc: "Most sacred & widely worn bead", price: "499", originalPrice: "", cta: "View Collection", link: "/products?category=5+Mukhi", bg: "from-[#001a0a] to-[#003d1f]", accent: "#4ADE80", image: "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=300&q=80" },
...
export default function PromoBanners() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-5">
      <div
      ...
      >
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={`bg-gradient-to-r ${banner.bg} flex items-center justify-between min-h-[150px] sm:min-h-[180px] px-6 sm:px-10 py-6 gap-6`}
          >
            {/* Left content */}
